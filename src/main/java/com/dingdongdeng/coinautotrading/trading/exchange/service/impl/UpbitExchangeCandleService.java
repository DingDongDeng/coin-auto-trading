...
public class UpbitExchangeCandleService implements ExchangeCandleService {
  ...
  public ExchangeCandles getCandles(
      CoinType coinType,
  ...
  private LocalDateTime getlimitedEndDateTime(
      CandleUnit candleUnit, LocalDateTime start, LocalDateTime end) {
  ...
  private int getCandleCount(
      CandleUnit candleUnit, LocalDateTime start, LocalDateTime limitedEndDateTime) {
    Long diff = null;
    switch (candleUnit.getUnitType()) {
      case WEEK:
