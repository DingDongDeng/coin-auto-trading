...
public class BinanceFutureClient extends Client {
  ...
  public BinanceFutureClient(
      WebClient binanceFutureWebClient,
      BinanceFutureTokenGenerator tokenGenerator,
      BinanceFutureSignatureWrapper signatureWrapper,
      QueryParamsConverter queryParamsConverter) {
  ...
  public String getServerTime() {
    return get("/fapi/v1/time", new ParameterizedTypeReference<>() {}, new HttpHeaders());
  }

  public List<FutureAccountBalanceResponse> getFuturesAccountBalance(
      FuturesAccountBalanceRequest request, String keyPairId) {
    return get(
        "/fapi/v2/balance",
