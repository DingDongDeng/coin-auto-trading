...
public class UpbitClient extends Client {
  ...
  public UpbitClient(
      WebClient upbitWebClient,
      UpbitTokenGenerator tokenGenerator,
  ...
  public List<AccountsResponse> getAccounts(String keyPairId) {
    return get("/v1/accounts", new ParameterizedTypeReference<>() {}, makeHeaders(null, keyPairId));
  }

  public OrdersChanceResponse getOrdersChance(OrderChanceRequest request, String keyPairId) {
    return get(
        "/v1/orders/chance", request, OrdersChanceResponse.class, makeHeaders(request, keyPairId));
  }
  ...
  public List<CandleResponse> getMinuteCandle(CandleRequest request, String keyPairId) {
    return get(
        "/v1/candles/minutes/" + request.getUnit(),
        request,
        new ParameterizedTypeReference<>() {},
        makeHeaders(request, keyPairId));
  }
