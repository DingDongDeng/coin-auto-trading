...
public class UpbitExchangeService implements ExchangeService {
  ...
  public ExchangeOrderCancel orderCancel(ExchangeOrderCancelParam param, String keyPairId) {
    ...
    OrderCancelResponse response =
        upbitClient.orderCancel(
            OrderCancelRequest.builder().uuid(param.getOrderId()).build(), keyPairId);
  ...
  public ExchangeTradingInfo getTradingInformation(
    ...
    AccountsResponse accounts =
        upbitClient.getAccounts(keyPairId).stream()
            .findFirst()
  ...
  public ExchangeOrder getOrderInfo(ExchangeOrderInfoParam param, String keyPairId) {
    return makeExchangeOrder(
        upbitClient.getOrderInfo(
            OrderInfoRequest.builder().uuid(param.getOrderId()).build(), keyPairId));
  }
    ...
    return ExchangeCandles.builder()
        ...
        .candleList(
            response.stream()
                .map(
                    candle ->
                        ExchangeCandles.Candle.builder()
