package com.dingdongdeng.coinautotrading.trading.exchange.scheduler;
...
public abstract class CandleStoreJob implements Job {
  ...
  public void execute(JobExecutionContext context) throws JobExecutionException {
    ...
    //            Candle candle =
    // candleService.findOneLastCandle(exchangeCandleService.getCoinExchangeType(), coinType,
    // CANDLE_UNIT)
    //
    ...
    //                .getCandleList(coinType, CANDLE_UNIT, candle.getCandleDateTimeKst(),
    // LocalDateTime.now(), ""); //fixme keyPairId 로직 필요
