...
public class BackTestingCandleLoader {
  ...
  @Default private CandleUnit candleUnit = CandleUnit.UNIT_1M;
  private LocalDateTime start;
  private LocalDateTime end;

  private List<Candle> candleList;
  @Default private int cursor = -1;
  ...
  public Candle getNextCandle() {
    ...
    if (nextCandle.getCandleDateTimeKst().isBefore(end)
        || nextCandle.getCandleDateTimeKst().equals(end)) {
      return nextCandle;
    }
  ...
  private ExchangeCandles getCandles(
