...
class IndexCalculatorTest {
  ...
  @Autowired private IndexCalculator calculator;
  ...
  private ExchangeCandles getExchangeCandles(
      LocalDateTime now, TradingTerm tradingTerm, CoinType coinType, String keyPairId) {
